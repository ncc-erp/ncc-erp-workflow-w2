...
namespace W2.Activities
{
    ...
    public class SendEmailToMyPM : CustomEmail
    {
        ...
        public SendEmailToMyPM(ISmtpService smtpService,
            ...
            IProjectClientApi projectClientApi) : base(smtpService, options, httpClientFactory, taskAppService, komuAppService, workflowDefinitionAppService, taskQueue,contentSerializer)
        {
