...
namespace W2.Migrations
{
    ...
    [Migration("20230615035338_AddWorkflowInstanceStakeHolder")]
    partial class AddWorkflowInstanceStakeHolder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("W2.WorkflowDefinitions.WorkflowCustomInputDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PropertyDefinitions")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("W2.WorkflowInstanceStates.WorkflowInstanceStakeHolder", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("WorkflowInstanceStateId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("UserId", "WorkflowInstanceStateId");

                    b.HasIndex("WorkflowInstanceStateId");

                    b.ToTable("WorkflowInstanceStakeHolders", (string)null);
                });

            modelBuilder.Entity("W2.WorkflowInstanceStates.WorkflowInstanceState", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WorkflowInstanceStarterId");

                    b.ToTable("WorkflowInstanceStates", (string)null);
                });
            ...
            modelBuilder.Entity("W2.WorkflowInstanceStates.WorkflowInstanceStakeHolder", b =>
                {
                    ...
                    b.HasOne("W2.WorkflowInstanceStates.WorkflowInstanceState", "WorkflowInstanceState")
                    ...
                    b.Navigation("WorkflowInstanceState");
                });

            modelBuilder.Entity("W2.WorkflowInstanceStates.WorkflowInstanceState", b =>
                {
                    b.HasOne("W2.WorkflowInstances.WorkflowInstanceStarter", "WorkflowInstanceStarter")
                        .WithMany("States")
                        .HasForeignKey("WorkflowInstanceStarterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("WorkflowInstanceStarter");
                });
